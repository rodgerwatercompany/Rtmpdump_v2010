            ...
            struct _getopt_data *d)
{
  ...
  if (optstring[0] == '-')
    {
      d->__ordering = getopt_data_::RETURN_IN_ORDER;
      ++optstring;
    }
  else if (optstring[0] == '+')
    {
      d->__ordering = getopt_data_::REQUIRE_ORDER;
      ++optstring;
    }
  else if (d->__posixly_correct)
    d->__ordering = getopt_data_::REQUIRE_ORDER;
  else
    d->__ordering = getopt_data_::PERMUTE;
...
# define NONOPTION_P (argv[d->optind][0] != '-' || argv[d->optind][1] == '\0')
  ...
  if (d->__nextchar == NULL || *d->__nextchar == '\0')
    ...
    d->__first_nonopt = d->optind;
      ...
      if (d->__ordering == getopt_data_::PERMUTE)
    {
      ...
      if (d->optind == argc)
    {
     ...
     either stop the scan or describe it to the caller and pass it by.  */
      ...
      if (NONOPTION_P)
    {
      if (d->__ordering == getopt_data_::REQUIRE_ORDER)
        return -1;
